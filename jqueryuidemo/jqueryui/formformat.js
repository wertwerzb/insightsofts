...
/* if( ggg [i].grouprow ==0)
 	{
 	var bb= (object2String(ggg[i].editor.options))  ;
 	
			var jjj= bb.substring(1,bb.length-1);
 		 obString ='<input class=\"easyui-'+ editortype.trim()+'\"'+
			  ' data-options=\"'+ jjj+ 
			 '\" height=100%; width='+ widthstr+' name =\"'+ ggg[i].field+
			 '\"></input>'+ searchst ; 
			 }
			 else
		
		
			 obString ='<input type=\"'+ editortype.trim()+'\"'+
			 ' height=100%  width='+ widthstr+' name =\"'+ ggg[i].field+
			 '\"></input>'+ searchst ;
