<script type="text/javascript">
 ...
 $.get("/MainInit",
  {
 hre: hrefstr +"_getsecondinit_mainview.OuterList" 
 },function( datastr ) { 
...
displayList();
  ...
  function CallFunc(mm, ggg , formstr, awidth,bwidth ) { 
...
$("#savebutton").css("display", "none");
  ...
  var st="";
 if(statemod=="add")st="Add";
 else if (statemod=="edit")st= "Edit"  ; 
 else return;
 
 
   $("#hrefstr").val( hrefstr+"_"+st+"_otheractions.Form"+st+"_Mouter" );
$("#myForm").form("submit",{
			url :"/MainEdit",
