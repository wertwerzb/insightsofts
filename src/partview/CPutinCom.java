...
import util.innpath;
import util.S_Param;
public class CPutinCom 
{
	private String  title;
private String searchbox;
private String indexfield;
private String indextitle; private String outfield; 	  private String injoinform;	  	  private String outsigleform;
...
public CPutinCom(String role, String userstr, String hreft,String langName)
	{
	usercode=userstr;
		rolestr = role;
		 langstr=langName;
...
// String result="{\"title\":" gettitlehtml() +",\"idfield\":\""+ idfield +",\"pagelist\""+ "["+ rowcount +","+( rowcount *2 ) +","+( rowcount *3 ) +","+( rowcount *4)+"]" +",\"grouptitle\":\""+ searchbox +"\"," +outfield ;
...
" and " + constr + ") as #mytable " +
	...
	public String getrecord(String condstr) throws Exception
	{
	 	String sqlstr= getindexsql (condstr);
			String pagetotal= gettotal( condstr);
		String resultstr = Gridprecord.getsrecord( indexfield , sqlstr, pagetotal); 
		return resultstr;
		// return sqlstr;
	}
	
	// condstr 选择id号， idstr新id号
public void insertrecord (String condstr,String idstr) throws Exception 
	{
  ...
  Statement dbc = conn.createStatement();
	...
	//choicegrid.xml" ;
	 String 	 realPath= innpath.getxmlpath( rolestr,usercode,"/Pputincom/"+ hreft+".xml" );
