...
sy.changeLang = function(languageName) {


	$.cookie('LangName',languageName, {
		expires : 7
	});
};
/**
 ...
 * @returns string
 */
 function disableCom(form,selectcom) {
var hitem;
if( selectcom=="ALL⊙" ){
$.each( form.serializeArray(), function(index) {
...
$("input[name='"+this['name']+"']").attr('disabled',true);
 ...
 hitem= selectcom.split(",");
 for(var i=0;i< hitem.length;i++ )
 {
 
 //$("input[name='"+ hitem[i] +"']").attr('editable',flase);
 
 $("input[name='"+ hitem[i] +"']").attr('disabled',true);
 
 }
 }

}
function enableCom(form,selectcom) {
var hitem;
if( selectcom=="ALL⊙" ){
$.each( form.serializeArray(), function(index) {

	$("input[name='"+this['name'] +"']").attr('disabled',false);
 ...
 for(var i=0;i< hitem.length;i++ )
 {
 $("input[name='"+ hitem[i] +"']").attr('onlyread',false);
 $("input[name='"+ hitem[i] +"']").attr('disable',false);
